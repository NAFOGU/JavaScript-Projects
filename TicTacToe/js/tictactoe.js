...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If active player is equal to 'X', the x.jpg is placed in HTML
            select.style.backgroundImage = 'url(./images/X.png)';
            //Active player may only be X or O, hence if not X it is must be O
        } else {
        ...
        if (activePlayer === 'X') {
            //If activePlayer equals 'X', change it to 'O'.
            activePlayer = 'O';
        ...
        //This condition checks to see if is the computer's turn.
        if (activePlayer === 'O') {
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //This line incicates where the end of a lines x axis is.
        x2 = coordX2,
